...
-----01
SELECT firstname, HE.address, SC.companyname
FROM HR.Employees HE
INNER JOIN Sales.Orders SO
ON SO.empid=HE.empid
INNER JOIN Sales.Customers SC
ON SC.custid=SO.custid
WHERE SC.companyname LIKE '%%'
-----02
SELECT HE.firstname, SC.companyname,HE.city, HE.address
FROM HR.Employees HE
INNER JOIN Sales.Orders SO
ON SO.empid=HE.empid
INNER JOIN Sales.Customers SC
...
-----04
SELECT SC.companyname, SUM(SO.freight)'SUM'
FROM Sales.Orders SO
INNER JOIN Sales.Customers SC
ON SC.custid=SO.custid
GROUP BY SC.companyname
HAVING SUM(SO.freight)>100000
-----05